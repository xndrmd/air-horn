...
const val DATABASE_NAME = "airhorn-db"

const val SHARED_PREFERENCES_NAME = "airhorn-sp"
const val SHARED_PREFERENCES_EVENT_SHAKE = "activation-settings-event-shake"
